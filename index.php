            ...
            <div class="col-md-8 col-sm-12">
                <form action="<?php echo $base_url; ?>/product-form.php" method="post" enctype="multipart/form-data">
                    ...
                    <?php if(empty($result['id'])): ?>
                        <button class="btn btn-primary" type="submit"><i class="fa-regular fa-floppy-disk me-1"></i>บันทึก</button>
                    <?php else: ?>
                        <button class="btn btn-success" type="submit"><i class="fa-regular fa-floppy-disk me-1"></i>บันทึก</button>
                    <?php endif; ?>
                    ...
                    <tbody>
                        <?php if($rows > 0): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a role="button" href="<?php echo $base_url; ?>/index.php?id=<?php echo $product['id']; ?>" class="btn btn-outline-dark"><i class="fa-regular fa-pen-to-square me-1"></i>แก้ไข</a>
                                    <a onclick="return confirm('Are your sure you want to delete?');" role="button" href="<?php echo $base_url; ?>/product-delete.php?id=<?php echo $product['id']; ?>" class="btn btn-outline-danger"><i class="fa-solid fa-trash me-1"></i>ลบ</a>
                                </td>
                            </tr>
                            <?php endwhile; ?>
                        <?php else: ?>
